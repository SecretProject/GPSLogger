...
public class GPSTracker extends Service implements LocationListener {
	...
	try {
		...
		Toast.makeText(GPSTracker.this, "No provider is enabled",Toast.LENGTH_LONG).show();
	    } else {
		...
		if (isGPSEnabled) {
			...
			locationManager.requestLocationUpdates(
				LocationManager.GPS_PROVIDER,Constants.MIN_TIME_BW_UPDATES,Constants.MIN_DISTANCE_CHANGE_FOR_UPDATES, this);
